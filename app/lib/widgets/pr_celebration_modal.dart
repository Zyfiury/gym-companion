...
class PrCelebrationModal extends StatefulWidget {
  ...
  static Future<void> show(BuildContext context, PendingPrCelebration celebration) {
    return showDialog(
      ...
      builder: (_) => PrCelebrationModal(celebration: celebration),
    );
  }
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                const Icon(Icons.emoji_events, color: AppColors.ember, size: 48),
...
class _ConfettiPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < 24; i++) {
      final paint = Paint()
        ..color = [AppColors.emerald, AppColors.ember, AppColors.accent, AppColors.volt][i % 4]
